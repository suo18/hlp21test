...
*)
let q4 (lsts: 'a list list) (lst: 'a list): 'a list list = failwithf "Not answered"
...
*)
let q5 (lsts: 'a list list): 'a list list = failwithf "Not answered"
...
*)
let q6 (left: int list) (right: int list): int list = failwithf "Not answered"
...
*)
let q7 (el: int) (setOfSets: int Set Set) = failwithf "Not answered"

(*
Q8) Given a map and a value, return a Set of all the keys that are mapped to the value.
*)
let q8 (map: Map<'a, 'b>) (x: 'b): Set<'a> = failwithf "Not answered"
